    ...
    return `
      <div class="receipt" id="receipt-printable">
        <div class="receipt-header">
          <div class="receipt-shop-name">${settings.shop_name || 'SAHAJA MOTORCYCLE LIMITED'}</div>
    ...
    return `
      <div class="daily-report" id="daily-report-printable">
        <div class="daily-report-header">
          ...
          <div>${settings.shop_name || 'SAHAJA MOTORCYCLE LIMITED'}</div>
        ...
        <div class="daily-report-footer">
          ${settings.shop_name || 'SAHAJA MOTORCYCLE LIMITED'} — Internal Report<br>
